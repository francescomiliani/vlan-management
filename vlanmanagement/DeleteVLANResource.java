...
/**
  ...
  * Calls removeVlan method with the above extracted parameters as input
  * removeVlan is implemented in the VLAN MANAGER class
  * The HTTP Request type is POST because a set of parameters has to be transmitted
*/
public class DeleteVLANResource extends ServerResource  {
	...
	public Object handleRequest( String fmJson ) {//fmJon will be equal to {"vlanid":"v1"} for instance
		...
		try {
			...
			response = (String)vmi.removeVlan(vlan);
		} catch (IOException e) {
